...
This is a Framework design for conducting Systematic Literature Review Research using Human in the Loop. The framework adapts Kitcherham and Charter SLR and uses the following Techniques alongside Human review of the Literature; Latent Dirichlet Allocation (LDA), Sentence-BERT (SBERT) and BERTopic, and LLM using Opensource GPT-neo and FLAN t-5
